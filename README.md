...
![pass if equal conn pane](docs/images/pass if equal 1d array con pane.png?raw=true)
...
![pass if equal string conn pane](docs/images/pass if equal string.png?raw=true)
...
![pass if matches conn pane](docs/images/pass if matches string.png?raw=true)
